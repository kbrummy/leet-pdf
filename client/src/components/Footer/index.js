...
import {BottomNavigation, BottomNavigationAction, Typography, Card} from '@material-ui/core';
...
const Footer = () => {
    ...
    return(
        <div className={classes.footerContainer}>
            ...
            <Typography>Ian Astesana
                <BottomNavigationAction
                    href="https://github.com/Greezon" target="_blank"
                    className={classes.root}
                    style={{padding: 0}}
                    icon={<GitHubIcon/>}
                />
            </Typography>
            <Typography>Kristin Brumfield
            <BottomNavigationAction
